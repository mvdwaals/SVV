...
aper_roll = struct('Name','Aperiodic Roll','t_init',35500,'t_end',36000);

%Initial time: Dutch Roll - Undamped
dutch_roll_undamped = struct('Name','Dutch Roll - Undamped','t_init',36470,'t_end',37199);

%Initial time: Dutch Roll - Yaw Damper
dutch_roll_damped = struct('Name','Dutch Roll - Damped','t_init',37190,'t_end',38249);

%Initial time: Spiral - 1st
spiral_1 = struct('Name','Spiral (1st)','t_init',38250,'t_end',38899);

%Initial time: Spiral - 2nd
spiral_2 = struct('Name','Spiral (2nd)','t_init',38900,'t_end',41150);

...
aper_roll = struct('Name','Aperiodic Roll','t_init',35776,'t_end',36066);

%Initial time: Dutch Roll - Undamped
dutch_roll_undamped = struct('Name','Dutch Roll - Undamped','t_init',36066,'t_end',36641);

%Initial time: Dutch Roll - Yaw Damper
dutch_roll_damped = struct('Name','Dutch Roll - Damped','t_init',37266,'t_end',37426);
...
spiral_2 = struct('Name','Spiral (2nd)','t_init',38906,'t_end',40561);
